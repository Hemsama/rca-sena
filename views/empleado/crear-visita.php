...
<a href="/visita" class="boton enlace2">Volver</a>

<form action="/crear-visita" method="POST" class="formulario datos">
    ...
    <input type="submit" value="Agendar" class="boton enlace">
</form>